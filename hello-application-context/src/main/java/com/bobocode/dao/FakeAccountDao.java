 ...
 * <p>
 * todo: configure this class as Spring component with bean name "accountDao"       x
 * todo: use explicit (with {@link Autowired} annotation) constructor-based dependency injection        x
 */
@Component("accountDao")    //R?
